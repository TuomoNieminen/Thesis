...
Binomial maxSPRT (BmaxSPRT) is a variant of maxSPRT based on a self-controlled study design such as the SCCS. The BmaxSPRT method addresses hypotheses concerning the relative incidence of adverse events during specified risk and control periods. The derivation of the decision rules for BmaxSPRT, including the computation of critical values, is described in detail both mathematically and algorithmically in this work.
