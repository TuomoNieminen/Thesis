...
The chosen maximum number of observations affects the power of BmaxSPRT. Instead of directly specifying the number of observations, a desired power corresponding to a specified rate ratio could be chosen and the maximum number of events correspoding to that power could then be computed. In this study the maximum number of observations was directly chosen. 
