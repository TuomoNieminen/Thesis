...
The information related to a possible causal relationship between a drug and an adverse event is called a safety signal (signal). Safety surveillance is interested in finding these signals. According to @Nelson2015 [p. 179], post-licensure safety aims related to drugs can be classified into three stages:
