...
options <- c("Continuously over time, at discrete time points (groupeded data)", 
...
- Chapter 3 discusses the decision elements in vaccine safety surveillance, focusing on sequential hypothesis testing. Data accumulation and the case of grouped observations is briefly discussed in section 3.4.
